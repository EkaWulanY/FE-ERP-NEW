...
<head>
    ...
    <title>Tambahan Pertanyaan Form Lamaran Admin</title>
        ...
                <div class="bg-white rounded-2xl shadow-xl p-8 mb-8">
            ...
                        <form action="#" method="POST">
                ...
                                <div class="mb-6">
                    ...
                                        <select name="job_id" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                                    </div>
                            </form>
                        <h3 class="text-lg font-bold text-gray-800 mt-8 mb-4">Pertanyaan Tambahan</h3>
                        <div class="space-y-4 mb-6 overflow-y-auto max-h-[300px] p-2 border border-gray-200 rounded-lg">
